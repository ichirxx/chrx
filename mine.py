...
def get_temp_email(fname, lname, domain_choice=None):
    ...
    if domain_choice == "1":
        ...
        domain = random.choice(['lcxmail.site', 'harakirimail.com', 'yopmail.com', 'ygmail.cfd', 'chxlxz.store'])
...
def main():
    while True:
        ...
        domain_choice = Prompt.ask(f"{O}[►]{W} Select", choices=["1", "2", "3", "4", "5", "b"], default="4")
